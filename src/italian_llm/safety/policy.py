...
ACQUISITION_INTENT = [
    ...
    "come procurarsi",
    "come procurare",
    "come acquistare illegalmente",
    "mercato nero",
    "dark web",
    "comprare illegalmente",
]
...
WEAPONS_CBRN = [
    ...
    "testata nucleare",
    "pistola stampata",
    "stampa 3d di una pistola",
    "silenziatore artigianale",
    "lanciafiamme",
    "ied",
    "nitroglicerina",
...
MALWARE_HARM_INTENT = [
    ...
    "estor",
    "ricatt",
    "cifrare i file della",
    "criptare i file della",
    "diffondere",
    "infettare",
    "spiare",
    "danneggiare",
...
DRUG_PRODUCTION = [
    "sintetizzare metanfetamina",
    "produrre metanfetamina",
    "fare la metanfetamina",
    "come fare la cocaina",
    "produrre cocaina",
    "raffinare cocaina",
    "sintesi mdma",
    "produrre mdma",
